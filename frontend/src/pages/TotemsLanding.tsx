...
const TotemsLanding = () => {
  ...
  useEffect(() => {
    ...
    const fetchExamples = async () => {
      ...
      try {
        const response = await fetch('/examples/totems.json');
        if (response.ok) {
          ...
          <div className="container mx-auto max-w-6xl">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              ...
              <div className="text-center p-8 rounded-2xl bg-gradient-card border border-border/50" style={{ borderColor: 'hsl(25, 45%, 35%, 0.2)' }}>
                ...
                <p className="text-muted-foreground">
                  Руны, кресты, мандалы, янтры — символы христианства, буддизма, индуизма и других традиций
                </p>
              </div>
          ...
          <div className="container mx-auto max-w-4xl">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
                В христианстве, буддизме, индуизме, славянской и скандинавской традициях —
                тотем это не просто украшение. Это связь с силой природы, богов, предков и внутренним "я".
